...
var DeparseError = class extends Error {
  name = "DeparseError";
};
...
var PgParser = class {
  ...
  async #loadFactory(version) {
    switch (version) {
      case 15:
        return await import("../wasm/15/pg-parser.js").then((module) => module.default);
      case 16:
        return await import("../wasm/16/pg-parser.js").then((module) => module.default);
      case 17:
        return await import("../wasm/17/pg-parser.js").then((module) => module.default);
      default:
        throw new Error(`unsupported version: ${version}`);
    }
  }
